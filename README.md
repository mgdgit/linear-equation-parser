...
- Tokenize linear equations and expressions
- Convert expressions into a structured representation
- Build and evaluate an abstract syntax tree
- Continue toward a more complete linear equation solver
